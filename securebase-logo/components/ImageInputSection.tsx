      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl">
        ...
        {previewSrc && (
          <div className="mt-8 mb-4 flex justify-center">
            <HolographicCard className="w-48 h-48" intensity={15}>
                <div className="w-full h-full bg-slate-800/50 backdrop-blur-md rounded-2xl border border-white/10 flex items-center justify-center p-6 shadow-2xl">
                     <img src={previewSrc} className="max-w-full max-h-full object-contain drop-shadow-xl animate-float" />
                </div>
            </HolographicCard>
          </div>
        )}
