...
import MarketingAssetGenerator from './components/MarketingAssetGenerator';
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 pb-20 overflow-x-hidden font-sans">
      ...
      <div className={`transition-opacity duration-1000 ${showIntro ? 'opacity-0' : 'opacity-100'}`}>
        ...
        <main className="container mx-auto px-4 pt-8 md:pt-12 animate-fade-in-up">
