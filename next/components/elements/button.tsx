...
export const Button: React.FC<ButtonProps> = ({
  ...
  // Draft mode appends invisible stega markers to every Strapi string, so a
  // raw comparison never matches and the button silently falls through to the
  // default style. Strip before comparing.
  const variant = stripStegaMarkers(rawVariant ?? '') || 'primary';
