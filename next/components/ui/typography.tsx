...
const typographyVariants = cva("font-sans", {
  variants: {
    variant: {
      ...
      p: "font-extralight leading-10 tracking-[0%] text-center text-[18px] sm:text-[20px] md:text-[24px] lg:text-[28px] xl:text-[32px]",
      base: "font-extralight leading-8 tracking-[0%] text-[14px] sm:text-[16px] md:text-[18px] lg:text-[20px] xl:text-[24px]",
