      ...
      <div className="max-w-3xl mx-auto  relative z-30 h-80">
        <div className="relative pb-12 md:pb-20">
          ...
          <div className="text-center">
            {/* Testimonial image */}
            <div className="relative h-40 mask-[linear-gradient(0deg,transparent,#FFFFFF_30%,#FFFFFF)] md:mask-[linear-gradient(0deg,transparent,#FFFFFF_40%,#FFFFFF)]">
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[480px] h-[480px] -z-10 pointer-events-none before:rounded-full rounded-full before:absolute before:inset-0 before:bg-linear-to-b before:from-neutral-400/20 before:to-transparent before:to-20% after:rounded-full after:absolute after:inset-0 after:bg-neutral-900 after:m-px before:-z-20 after:-z-20">
              ...
              <div className="relative flex flex-col" ref={testimonialsRef}>
                {slicedTestimonials.map((item: any, index: number) => (
                  <Transition
                    ...
                    beforeEnter={() => heightFix()}
                  >
                    <div className="text-base md:text-xl font-bold bg-clip-text text-transparent bg-linear-to-r from-neutral-200/60 via-neutral-200 to-neutral-200/60">
                      {item.text}
                    </div>
                  </Transition>
                ))}
            ...
            <div className="flex flex-wrap justify-center -m-1.5 px-8 sm:px-6">
              {slicedTestimonials.map((item: any, index: number) => (
                <button
                  className={cn(
                    `px-2 py-1 rounded-full m-1.5 text-xs border border-transparent text-neutral-300 transition duration-150 ease-in-out [background:linear-gradient(var(--color-neutral-900),var(--color-neutral-900))_padding-box,conic-gradient(var(--color-neutral-400),var(--color-neutral-700)_25%,var(--color-neutral-700)_75%,var(--color-neutral-400)_100%)_border-box] relative before:absolute before:inset-0 before:bg-neutral-800/30 before:rounded-full before:pointer-events-none ${
                      active === index
                        ? 'border-secondary/50'
